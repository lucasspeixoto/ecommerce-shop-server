...
import com.ibm.shop.exceptions.InvalidJwtAuthenticationException;
...
public class JwtTokenProvider {
    ...
    @PostConstruct //CHamado logo após a inicialização do Spring
    protected void init() {
    ...
    /**
     * Vai ler o token e retornar objetos que
     * poderemos manipular
     */
    private DecodedJWT decodedToken(String token) {
        Algorithm _algorithm = Algorithm.HMAC256(secretKey.getBytes());
